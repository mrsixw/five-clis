...
# Generated by: five-clis config init
...
def load_config(config_path: str | None = None) -> dict:
    ...
    Returns an empty dict if no config file is found on the search paths.
    Raises ``ValueError`` if an explicitly given *config_path* does not exist
    or if a found file fails to parse.
    """
    if config_path:
